...
part 'drift_birdart.g.dart';

@DriftDatabase(tables: [Bird, Hotspot, DbImage, DbRecord, Checklist, Track])
class BirdartDatabase extends _$BirdartDatabase {
  BirdartDatabase() : super(_openConnection());

  @override
  int get schemaVersion => 1;

  Future<List<Checklist>> get checklistGetAll => select(checklist).get();
}
